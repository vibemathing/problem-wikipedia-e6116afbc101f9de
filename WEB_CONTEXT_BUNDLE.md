...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-e6116afbc101f9de"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-e6116afbc101f9de",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-e6116afbc101f9de",
        "url": "https://en.wikipedia.org/wiki/Szymanski%27s_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Szymanski's conjecture : every permutation on the $n$ -dimensional doubly- directed hypercube graph can be routed with edge-disjoint paths .",
      "version": 1
    },
    "title": "Szymanski's conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "635493988188b62a8761f4ae00a9a92535ead06af38e159b544c96692cef5314"
}
```
